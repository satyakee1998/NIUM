...
public String createOauthToken(String email, String password,HttpServletRequest request,String auth) throws JSONException
{
...
request.getSession().setAttribute("authstatus", "Server Undergoing Maintainance. Please Try Again In Few Minutes" );
