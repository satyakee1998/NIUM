    ...
    <div class="col-xl-10 col-lg-10 col-md-9 col-sm-12 rightMainSection">
      ...
      <div class="col-xl-9 addCustSection">
      	 <div class="headingSection">
            <div class="userBackBtn"> <a href="/nisguserlist"><img src="resources/nisg/images/userbackbtn.png" width="9" height="15" alt="Back" title="Back"></a> </div>
         	<h1>Add Customer</h1>
         ...
         <form action="/indexnew" method ="POST" id="adcustomerform">
         	...
         	<div class="formElementCon formElementConLR">
                <div class="form-group">
                    ...
                    <input type="text" name="first_name" onkeypress="return ((event.charCode > 64 &amp;&amp; event.charCode < 91) || (event.charCode > 96 &amp;&amp; event.charCode < 123) || event.charCode == 8 || event.charCode == 32 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57));" maxlength="15" class="form-control" value="" required>
                </div>
                <div class="form-group">
                    <label class="control-label">Middle Name</label>
                    <input type="text" name="middle_name"  class="form-control"  onkeypress="return ((event.charCode > 64 &amp;&amp; event.charCode < 91) || (event.charCode > 96 &amp;&amp; event.charCode < 123) || event.charCode == 8 || event.charCode == 32 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57));" maxlength="15" value="">
                </div>
                <div class="form-group">
                    <label class="control-label">Last Name<span>*</span></label>
                    <input type="text" name="last_name" class="form-control" value=""  onkeypress="return ((event.charCode > 64 &amp;&amp; event.charCode < 91) || (event.charCode > 96 &amp;&amp; event.charCode < 123) || event.charCode == 8 || event.charCode == 32 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57));" maxlength="15" required>
                </div>
                <!-- <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" title="Please enter number only" value="" name="phone_number" pattern="[0-9]+" minlength="5"  required>
                </div>
                <div class="form-group">
                    <label class="control-label">Email Id<span>*</span></label>
                    <input type="email" name="email" id="customemail" class="form-control" value="" required>
                </div>
                <div class="form-group">
            ...
            <div class="formElementCon formElementConLR">
            	<div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" required  onkeypress="return ((event.charCode > 64 &amp;&amp; event.charCode < 91) || (event.charCode > 96 &amp;&amp; event.charCode < 123) || event.charCode == 8 || event.charCode == 32 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57));" maxlength="35"   id="addr1" name="address_line_1" value=""  class="form-control">
                  </div>
                  <div class="form-group">
                    <label class="control-label">Address Line 2</label>
                    <input type="text"  onkeypress="return ((event.charCode > 64 &amp;&amp; event.charCode < 91) || (event.charCode > 96 &amp;&amp; event.charCode < 123) || event.charCode == 8 || event.charCode == 32 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57));" maxlength="35" name="address_line_2" value="" id="addr2"  class="form-control">
                  </div>
                  
                  <div class="form-group">
                    <label class="control-label">City<span>*</span></label>
                    <input type="text"  onkeypress="return ((event.charCode > 64 &amp;&amp; event.charCode < 91) || (event.charCode > 96 &amp;&amp; event.charCode < 123) || event.charCode == 8 || event.charCode == 32 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57));" maxlength="15" name="city" value="" id="cityold" required class="form-control">
                  </div>
                  <div class="form-group">
                    <label class="control-label">State<span>*</span></label>
                    <input type="text"  onkeypress="return ((event.charCode > 64 &amp;&amp; event.charCode < 91) || (event.charCode > 96 &amp;&amp; event.charCode < 123) || event.charCode == 8 || event.charCode == 32 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57));" maxlength="15"  required value="" name="state"  id="stateold" class="form-control">
                  </div>
            ...
            <div class="formElementCon formElementConLR">
            	<div class="form-group">
                  ...
                  <div class="form-group">
                    <label class="control-label">Address Line 1<span>*</span></label>
                    <input type="text"  onkeypress="return ((event.charCode > 64 &amp;&amp; event.charCode < 91) || (event.charCode > 96 &amp;&amp; event.charCode < 123) || event.charCode == 8 || event.charCode == 32 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57));" maxlength="35" required id="addr1new" value="" name="billing_address_line_1" class="form-control">
                  </div>
                  <div class="form-group">
                    <label class="control-label">Address Line 2</label>
                    <input type="text"  id="addr2new" value=""  onkeypress="return ((event.charCode > 64 &amp;&amp; event.charCode < 91) || (event.charCode > 96 &amp;&amp; event.charCode < 123) || event.charCode == 8 || event.charCode == 32 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57));" maxlength="35" name="billing_address_line_2"  class="form-control">
                  </div>
                 
                  <div class="form-group">
                    <label class="control-label">City<span>*</span></label>
                    <input type="text" required  onkeypress="return ((event.charCode > 64 &amp;&amp; event.charCode < 91) || (event.charCode > 96 &amp;&amp; event.charCode < 123) || event.charCode == 8 || event.charCode == 32 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57));" maxlength="15"  id="citynew" value="" name="billing_city"  class="form-control">
                  </div>
                  <div class="form-group">
                    <label class="control-label">State<span>*</span></label>
                    <input type="text"   onkeypress="return ((event.charCode > 64 &amp;&amp; event.charCode < 91) || (event.charCode > 96 &amp;&amp; event.charCode < 123) || event.charCode == 8 || event.charCode == 32 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57));" maxlength="15"  required name="billing_state" id="statenew"  value="" class="form-control">
                  </div>
...
<script src="resources/smtp.js"></script>
 ...
 <script src="resources/assets/scripts/addcustomers2.js"></script>
