...
public interface Constant {
	...
	String Email = "testadminnisg01@yopmail.com";
	String Password = "W@llet123";
	String OauthUrl = "http://developer.sandbox.stylopay.com:8081";
	String MMUrl="http://developer.sandbox.stylopay.com:8081/api-mm";
	String cardTypeCode ="stylopaymcpcard";
	String assoc_number = "PY";
